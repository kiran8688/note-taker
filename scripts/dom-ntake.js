document.addEventListener("DOMContentLoaded", () => {
    ...
    const createTask = () => {
        ...
        cardContRow.className = `group flex items-center justify-between p-4 sm:p-5 rounded-[1.5rem] transition-all duration-300 ease-out bg-white/80 backdrop-blur-2xl hover:bg-white/90 border border-white/60 shadow-[0_4px_20px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] mb-3 relative overflow-hidden ${isChecked ? 'opacity-60 scale-[0.99] grayscale-[30%]' : 'hover:-translate-y-1'}`;
