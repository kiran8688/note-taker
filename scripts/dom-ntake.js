document.addEventListener("DOMContentLoaded", () => {
    ...
    const createTask = () => {
        ...
        cardContRow.className = `group flex items-center justify-between p-3 sm:p-4 rounded-2xl transition-all duration-300 ease-out bg-white/40 hover:bg-white/50 backdrop-blur-md border border-white/60 shadow-sm hover:shadow-md mb-2 relative overflow-hidden ${isChecked ? 'opacity-60 scale-[0.99] grayscale-[30%]' : 'hover:-translate-y-0.5'}`;
        ...
        toggleCheck.addEventListener('change', (e) => {
            ...
            if (checked) {
                cardContRow.className = 'group flex items-center justify-between p-3 sm:p-4 rounded-2xl transition-all duration-300 ease-out bg-white/40 backdrop-blur-md border border-white/60 shadow-sm mb-2 relative overflow-hidden opacity-60 scale-[0.99] grayscale-[30%]';
                ...
                cardContRow.className = 'group flex items-center justify-between p-3 sm:p-4 rounded-2xl transition-all duration-300 ease-out bg-white/40 hover:bg-white/50 backdrop-blur-md border border-white/60 shadow-sm hover:shadow-md mb-2 relative overflow-hidden hover:-translate-y-0.5';
