document.addEventListener("DOMContentLoaded", () => {
    ...
    const createTask = () => {
        ...
        // Securely render the time icon and task time.
        // We use innerHTML only for the static SVG icon and append the user-controlled timeofTask as a text node to prevent XSS.
        timeSpan.innerHTML = `<svg class="w-3.5 h-3.5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>`;
        timeSpan.append(document.createTextNode(timeofTask));
